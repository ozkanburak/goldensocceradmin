...
import 'package:firenase_crud2/pages/vip_edit.dart';
...
class _VipPageState extends State<VipPage> {
  final CollectionReference users = FirebaseFirestore.instance.collection('vip');
  @override
                            ...
                            endActionPane: ActionPane(motion: const StretchMotion(), children: [
                              SlidableAction(
                                ...
                                onPressed: (context) {
                                  ...
                                  UsersController3().deleteUsers(UserModel(id: list.id)); //documentSnapshottan sil
                                },
                                icon: Icons.delete,
