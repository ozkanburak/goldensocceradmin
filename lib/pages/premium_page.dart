...
import 'package:firenase_crud2/pages/premium_edit.dart';
...
class _PremiumPageState extends State<PremiumPage> {
  final CollectionReference users = FirebaseFirestore.instance.collection('premium');
  @override
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => const PremiumEdit(
                  user: null,
                ),
              ));
        },
                            ...
                            endActionPane: ActionPane(motion: const StretchMotion(), children: [
                              SlidableAction(
                                ...
                                onPressed: (context) {
                                  ...
                                  UsersController2().deleteUsers(UserModel(id: list.id)); //documentSnapshottan sil
                                },
                                icon: Icons.delete,
