...
class PremiumEdit extends StatefulWidget {
  final UserModel? user;
  final index;
  const PremiumEdit({super.key, this.user, this.index});

  @override
  State<PremiumEdit> createState() => _PremiumEditState();
}

class _PremiumEditState extends State<PremiumEdit> {
