...
import 'package:firenase_crud2/pages/high_edit.dart';
import 'package:flutter/gestures.dart';
import 'package:flutter/material.dart';
import 'package:flutter_slidable/flutter_slidable.dart';

class HighPage extends StatefulWidget {
  const HighPage({super.key});

  @override
  State<HighPage> createState() => _HighPageState();
}

class _HighPageState extends State<HighPage> {
  final CollectionReference users = FirebaseFirestore.instance.collection('high');
  @override
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => const HighEdit(
                  user: null,
                ),
              ));
        },
                            ...
                            endActionPane: ActionPane(motion: const StretchMotion(), children: [
                              SlidableAction(
                                ...
                                onPressed: (context) {
                                  ...
                                  UsersController4().deleteUsers(UserModel(id: list.id)); //documentSnapshottan sil
                                },
                                icon: Icons.delete,
